...
### Viagens de Lazer
Foco na experiência, personalização e realização de sonhos. O planejamento geralmente é feito com maior antecedência.
* **Serviços comuns:** Pacotes de passeios, cruzeiros (ex: MSC, Costa, Royal Caribbean), hotelaria resort, locação de carros, circuitos/excursões e aluguel de equipamentos (como esqui).
* **Segmentação de nichos:** Lua de mel, turismo religioso, intercâmbio, turismo esportivo, ecoturismo e turismo de luxo.

### Viagens Corporativas (B2B)
Foco em agilidade, custo-benefício, conformidade com políticas de viagens das empresas e suporte 24/7.
* **Serviços comuns:** Emissão rápida de passagens aéreas, reservas de hotéis executivos, traslados pontuais e seguro viagem.
* **Modelo de negócio:** Focado em contratos corporativos (com volume mínimo de emissão, remuneração mensal e acordos comerciais específicos).
...
### Estrutura de Receita e Taxas
* **Comissão:** Percentual pago pelo fornecedor (hotel, cruzeiro, operadora) à agência pela venda do seu produto.
...
* **No-show:** Quando o passageiro não se apresenta para o embarque ou para o check-in no hotel sem aviso prévio. Geralmente acarreta multas altíssimas ou perda total do valor.
* **GDS (Global Distribution System):** Sistemas globais (como Amadeus e Sabre) usados pelas agências e consolidadoras para reservar voos, hotéis e carros.
...
Abaixo, os principais produtos e serviços comumente comercializados pela agência, organizados por categoria de negócio:

| Produto/Serviço | Categoria Principal | Descrição Resumida |
| :--- | :--- | :--- |
| **Passagem Aérea** | Lazer/Corporativo | Emissões nacionais e internacionais (comerciais ou blocos fretados). |
| **Hotelaria** | Lazer/Corporativo | Reservas de hospedagem (resorts, hotéis executivos, pousadas). |
| **Aluguel de Carro** | Lazer/Corporativo | Locação de veículos com diferentes categorias e seguros inclusos. |
| **Traslado (Transfer)** | Lazer/Corporativo | Locomoção pré-contratada (in/out) do aeroporto para o hotel e vice-versa. |
| **Seguro Viagem** | Lazer/Corporativo | Assistência médica, odontológica e suporte contra extravio de bagagem. |
| **Cruzeiro Marítimo** | Lazer | Cabines em navios turísticos com roteiros fechados e refeições inclusas. |
